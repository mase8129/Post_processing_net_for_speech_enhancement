#!/bin/bash
#SBATCH -o ./jobs/1030_v101_mix2.%j.out            # Output-File
#SBATCH -J v101_mix2_22050	                                                # Job Name
...
python3 ./4_Model_train.py --n_epochs=30 --HPC=1 --model=101 --DS=5000 --loss_func=mix2 --batch_size=4 --data=voicefixer --sr=22050