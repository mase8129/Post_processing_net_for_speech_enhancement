...
#SBATCH -J clean_CNN_v9_stft	                                                # Job Name
...
#SBATCH --time=80:00:00                         	                # estimated time
...
python3 ./4_Model_train.py --n_epochs=50 --HPC=1 --model=9 --loss_func=stft --data=cleanraw --batch_size=4