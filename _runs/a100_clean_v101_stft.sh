...
#SBATCH -J demucs_clean_stft_kernel64_a100	                                                # Job Name
...
#SBATCH --time=100:00:00                         	                # estimated time
#SBATCH --partition=gpu						                        # which partition to run on
#SBATCH --mem=300G				                                    # XGiB resident memory pro node
...
python3 ./4_Model_train.py --n_epochs=200 --HPC=1 --model=101 --loss_func=stft --data=cleanraw --batch_size=8