#!/bin/bash
#SBATCH -o ./jobs/1030_v91_mix4.%j.out            # Output-File
#SBATCH -J v91_mix4_22050	                                                # Job Name
...
python3 ./4_Model_train.py --n_epochs=30 --HPC=1 --model=91 --DS=5000 --loss_func=mix4 --batch_size=4 --data=voicefixer --sr=22050