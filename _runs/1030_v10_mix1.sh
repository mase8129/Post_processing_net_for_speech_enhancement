#!/bin/bash
#SBATCH -o ./jobs/1030_v10_mix1.%j.out            # Output-File
#SBATCH -J v10_mix1_22050	                                                # Job Name
...
python3 ./4_Model_train.py --n_epochs=30 --HPC=1 --model=10 --DS=5000 --loss_func=mix1 --batch_size=4 --data=voicefixer --sr=22050