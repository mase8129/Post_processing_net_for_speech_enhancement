...
#SBATCH --time=20:00:00                         	                # estimated time
#SBATCH --partition=gpu						                        # which partition to run on
#SBATCH --mem=50G				                                    # XGiB resident memory pro node
...
python3 ./4_Model_train.py --n_epochs=100 --HPC=1 --model=82 --DS=500